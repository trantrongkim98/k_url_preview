...
class KVerticalUrlPreview extends StatefulWidget {
  ...
  @override
  _KVerticalUrlPreviewState createState() => _KVerticalUrlPreviewState();
}

class _KVerticalUrlPreviewState extends State<KVerticalUrlPreview> {
        ...
        children: [
          ConstrainedBox(
            constraints: BoxConstraints(
                ...
                maxWidth: widget.boxConstraints.maxWidth),
            child: KPreviewImage(
